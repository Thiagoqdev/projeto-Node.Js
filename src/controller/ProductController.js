...
export default class ProductController {
  ...
  //Oficial
  static async scheduleProduct(req, res) {
    try {
      const { id } = req.params;
      const message = await ProductService.scheduleProduct(req, id);
  ...
  static async update(req, res) {
    ...
    try {
      ...
      const { name, description, images, available, state, owner, reciever } =
        productData;
